...
public class HttpPostUtil {
    ...
    public static String PATH = "http://122.112.247.7/Order/Main/";
    ...
    public static String MENU_PATHPATH = PATH + "ShowMenu.php";
    public static String ORDER_ = PATH + "AddOrder.php";
